...
const CONTRACT_NAME: &str = "crates.io:cw-nride-escrow-v2";
...
pub fn create_payment_submsgs(escrow: Escrow) -> StdResult<Vec<SubMsg>> {
    let mut msgs: Vec<SubMsg> = vec![];
    if let Balance::Cw20(token) = escrow.deposit {
